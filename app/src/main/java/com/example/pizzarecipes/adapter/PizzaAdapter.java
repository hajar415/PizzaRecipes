...
public class PizzaAdapter extends BaseAdapter {
    ...
    public View getView(int pos, View convertView, ViewGroup parent) {
        ...
        ImageView img = convertView.findViewById(R.id.photoPizza);
        TextView tvNom = convertView.findViewById(R.id.nomPizza);
        TextView tvMeta = convertView.findViewById(R.id.infoPizza);
